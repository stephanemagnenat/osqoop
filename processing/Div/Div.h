...
//! Div plugin. divide two signals
class ProcessingDiv : public ProcessingPlugin
{
private:
	friend class ProcessingDivDescription;
	ProcessingDiv(const ProcessingPluginDescription *description) : ProcessingPlugin(description) { }
