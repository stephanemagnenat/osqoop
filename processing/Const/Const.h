...
#ifndef __PROCESSING_Const
#define __PROCESSING_Const
...
//! Const plugin. Generate a constant output
class ProcessingConst : public QObject, public ProcessingPlugin
{
	Q_OBJECT
...
private:
	...
	ProcessingConst(const ProcessingPluginDescription *description, const DataSource *dataSource);
