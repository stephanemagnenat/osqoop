...
#ifndef __PROCESSING_Gain
#define __PROCESSING_Gain

#include <ProcessingPlugin.h>

//! Description of gain plugin
class ProcessingGainDescription : public QObject, public ProcessingPluginDescription
{
	Q_OBJECT
	Q_PLUGIN_METADATA(IID "ch.eig.lsn.Oscilloscope.ProcessingPluginDescription/1.0" FILE "gain.json")
...
//! Gain plugin. Change the intensity of the signal
...
private:
	friend class ProcessingGainDescription;
	ProcessingGain(const ProcessingPluginDescription *description);
