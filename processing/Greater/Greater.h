...
//! Greater plugin. If A > B return C else return D
class ProcessingGreater : public ProcessingPlugin
{
private:
	friend class ProcessingGreaterDescription;
	ProcessingGreater(const ProcessingPluginDescription *description) : ProcessingPlugin(description) { }
