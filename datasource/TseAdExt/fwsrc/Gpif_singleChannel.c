...
// IF/Wait  Wait 2    IF        Wait 2    IF        Wait 1    Wait 1    Wait 1             
//   Term A           INT                 INT                                              
//   LFunc            OR                  OR                                               
//   Term B           INT                 INT                                              
...
// DO NOT EDIT ...                                                                         
const char xdata WaveData_singleChannel[128] =                                                           
{                                                                                          
// Wave 0                                                                                  
/* LenBr */ 0x02,     0x0A,     0x02,     0x3F,     0x01,     0x01,     0x01,     0x07,    
/* Opcode*/ 0x00,     0x01,     0x00,     0x03,     0x00,     0x00,     0x10,     0x00,    
/* Output*/ 0xFE,     0xFF,     0xF9,     0xFF,     0xFF,     0xFF,     0xFF,     0xFF,    
...
/* Opcode*/ 0x00,     0x03,     0x00,     0x00,     0x00,     0x00,     0x10,     0x00,    
...
// DO NOT EDIT ...                                                                         
const char xdata InitData_singleChannel[7] =                                                             
{                                                                                          
...
void GpifInit_singleChannel( void )
{
  BYTE i;
  ...
  GPIFREADYCFG = InitData_singleChannel[ 0 ];
  GPIFCTLCFG = InitData_singleChannel[ 1 ];
  GPIFIDLECS = InitData_singleChannel[ 2 ];
  GPIFIDLECTL = InitData_singleChannel[ 3 ];
  GPIFWFSELECT = InitData_singleChannel[ 5 ];
  GPIFREADYSTAT = InitData_singleChannel[ 6 ];
  ...
  // source
  APTR1H = MSB( &WaveData_singleChannel );
  APTR1L = LSB( &WaveData_singleChannel );
